...
public class DateUtil {
    ...
    public static SimpleDateFormat TIME_MINUTE = new SimpleDateFormat("HH:mm");
    ...
    public static String formatForTime(Date date){
        if(date != null){
            ...
            return TIME_MINUTE.format(date);
        }
        return "";
    }
     ...
     * @return 日期集合
     */
    public static String[] getCategories(String startStr, String endStr) {
        ...
        while (tempStart.before(tempEnd)) {
            String dateString = format.format(tempStart.getTime());
            result.add(dateString);
            tempStart.add(Calendar.DAY_OF_YEAR, 1);
        }
        String categories[] = result.toArray(new String[result.size()]);
        return categories;
    }
